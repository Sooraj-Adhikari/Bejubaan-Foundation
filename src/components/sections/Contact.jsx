            ...
            <div className="card info-sidebar-card">
              ...
              <div className="info-items">
                {[
                  ...
                  { icon: <Mail size={20} className="text-primary" />, label: 'Email Support', content: <a href="mailto:admin@bejubaanannsevafoundation.com">admin@bejubaanannsevafoundation.com</a> },
